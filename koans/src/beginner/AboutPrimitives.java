...
public class AboutPrimitives {
    ...
    public void wholeNumbersCanAlsoBeOfTypeShort() {
        Object s = (short)1;
        assertEquals(getType(s), s.getClass()); // The '(short)' is called an explicit cast - to type 'short'
    }
    ...
    public void charsCanOnlyBePositive() {
        ...
        // Character.MIN_VALUE / MAX_VALUE is not printable, so we have to cast it to see it
    }
